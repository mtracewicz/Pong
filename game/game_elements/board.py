...
class Board():
    ...
    def move_paddle(self, paddle, direction):
        new_position = self._paddles[paddle] + direction*Constants.SINGLE_MOVE
        if self._will_paddle_be_visible(new_position):
            self._paddles[paddle] = new_position
    ...
    def get_data(self):
        ...
        return [self._ball['x']/Constants.WIDTH, self._ball['y']/Constants.HEIGHT, self._ball['vx']/5, self._ball['vy']/5, self._paddles[paddle]/Constants.HEIGHT]
